            ...
            <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
                <View style={{ flex: 1, justifyContent: 'flex-start', alignItems: 'flex-start' }}>
                    ...
                    <Modal animationType='none' visible={modalVisible} transparent={true} onRequestClose={() => {
                        ...
                        <Camera_Gallery_review index={index} setIndex={setIndex} setPhoto1={setPhoto1} setPhoto2={setPhoto2} setPhoto3={setPhoto3} setPhoto4={setPhoto4} setPhoto5={setPhoto5} ordernum={info.styling_id} />
                    </Modal>
                    {istouched === false ?
                        <View style={{ flex: 1, width: '100%', }}>
                            ...
                            <View style={{ flex: 2, width: '100%', }}>
                                <View style={{ flex: 1, width: '100%', alignItems: 'center', justifyContent: 'center', }}>
                                    ...
                                    <Text style={{ fontSize: 17, color: '#969696', marginTop: 10, fontFamily: 'NanumSquare_acR', includeFontPadding: false, }}>{info.nick_name} 어드바이저</Text>
                                </View>
                        ...
                        <View style={{ flex: 1, width: '100%', justifyContent: 'center', alignItems: 'center', }}>
                            ...
                            <View style={{ flex: 40, width: '100%', paddingTop: 50 }}>
                                ...
                                <View style={{ flex: 5, width: '100%', paddingHorizontal: 20 }}>
                                    <Text style={{ marginBottom: 10, fontFamily: 'NanumSquare_acR', fontSize: 14 }}>{info.nick_name} 어드바이저 - {info.tpo}</Text>
                                    <TextInput style={{ height: 150, width: '100%', borderWidth: 1, borderColor: '#969696', fontSize: 14, }}
                                ...
                                <View style={{ flex: 5, width: '100%', flexDirection: 'row', paddingHorizontal: 15, justifyContent: 'space-around', }}>
                                    {photo1 !== '' ?
                                        <TouchableOpacity onPress={() => { setIndex(1) }} style={{ width: '15%', aspectRatio: 1 / 1, borderRadius: 5 }}>
                                            <FastImage source={{ uri: photo1.uri, cache: 'web' }} style={{ width: '15%', aspectRatio: 1 / 1, borderRadius: 5 }} resizeMode='stretch' />
                                        </TouchableOpacity> : <Add_photo index={1} />
                                    }
                                    {photo2 !== '' ?
                                        <TouchableOpacity onPress={() => { setIndex(2) }} style={{ width: '15%', aspectRatio: 1 / 1, borderRadius: 5 }}>
                                            <FastImage source={{ uri: photo2.uri, cache: 'web' }} style={{ width: '15%', aspectRatio: 1 / 1, borderRadius: 5 }} resizeMode='stretch' />
                                        </TouchableOpacity> : <Add_photo index={2} />
                                    }
                                    {photo3 !== '' ?
                                        <TouchableOpacity onPress={() => { setIndex(3) }} style={{ width: '15%', aspectRatio: 1 / 1, borderRadius: 5 }}>
                                            <FastImage source={{ uri: photo3.uri, cache: 'web' }} style={{ width: '15%', aspectRatio: 1 / 1, borderRadius: 5 }} resizeMode='stretch' />
                                        </TouchableOpacity> : <Add_photo index={3} />
                                    }
                                    {photo4 !== '' ?
                                        <TouchableOpacity onPress={() => { setIndex(4) }} style={{ width: '15%', aspectRatio: 1 / 1, borderRadius: 5 }}>
                                            <FastImage source={{ uri: photo4.uri, cache: 'web' }} style={{ width: '15%', aspectRatio: 1 / 1, borderRadius: 5 }} resizeMode='stretch' />
                                        </TouchableOpacity> : <Add_photo index={4} />
                                    }
                                    {photo5 !== '' ?
                                        <TouchableOpacity onPress={() => { setIndex(5) }} style={{ width: '15%', aspectRatio: 1 / 1, borderRadius: 5 }}>
                                            <FastImage source={{ uri: photo5.uri, cache: 'web' }} style={{ width: '15%', aspectRatio: 1 / 1, borderRadius: 5 }} resizeMode='stretch' />
                            ...
                            {review !== '' ?
                                <TouchableOpacity onPress={() => {
                                    ...
                                    axios.post(ip + 'mypage/review', {
                                        styling_id: info.styling_id,
                                        user_id: info.user_id,
                                        stylist_id: info.stylist_id,
                                        user_rating: rate,
                                        user_photo: photo5 !== '' ?
                                            s3 + 'Review/' + info.styling_id + '1.jpg,' +
                                            s3 + 'Review/' + info.styling_id + '2.jpg,' +
                                            s3 + 'Review/' + info.styling_id + '3.jpg,' +
                                            s3 + 'Review/' + info.styling_id + '4.jpg,' +
                                            s3 + 'Review/' + info.styling_id + '5.jpg' : photo4 !== '' ?
                                                s3 + 'Review/' + info.styling_id + '1.jpg,' +
                                                s3 + 'Review/' + info.styling_id + '2.jpg,' +
                                                s3 + 'Review/' + info.styling_id + '3.jpg,' +
                                                s3 + 'Review/' + info.styling_id + '4.jpg' : photo3 !== '' ?
                                                    s3 + 'Review/' + info.styling_id + '1.jpg,' +
                                                    s3 + 'Review/' + info.styling_id + '2.jpg,' +
                                                    s3 + 'Review/' + info.styling_id + '3.jpg' : photo2 !== '' ?
                                                        s3 + 'Review/' + info.styling_id + '1.jpg,' +
                                                        s3 + 'Review/' + info.styling_id + '2.jpg' : photo1 !== '' ?
                                                            s3 + 'Review/' + info.styling_id + '1.jpg' : 'No photo',
